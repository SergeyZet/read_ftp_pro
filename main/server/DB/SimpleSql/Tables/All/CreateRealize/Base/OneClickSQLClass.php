...
/*
		function getDataByCriterion($NameTable, &$targetCols, $criterionCols = false){
			$this->connect();
			$NameTableSheilded = $this->db->screening($NameTable);
			...
			$query = "SELECT ".$tarColsSheilded." FROM `$NameTableSheilded`" .$CritColsSheilded;
        	//echo $query;
