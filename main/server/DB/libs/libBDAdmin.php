...
{    
    ...
    function InitTables($db){
        ...
        //require_once '..//All/CreateRealize/libTables.php';
        /*
        require_once '..//classes//CreateRealize//examples//TableTypesRewards.php';
        require_once '..//classes//CreateRealize//examples//TableThemesExamples.php';
        require_once '..//classes//CreateRealize//examples//TableUsersRoles.php';
        require_once '..//classes//CreateRealize//examples//TableRanksUsers.php';

        require_once '..//classes//CreateRealize//examples//TableCities.php';
        require_once '..//classes//CreateRealize//examples//TableGroups.php';
        require_once '..//classes//CreateRealize//examples//TableRolesExamples.php';
        require_once '..//classes//CreateRealize//examples//TableStructuresTablesEE.php';

        require_once '..//classes//CreateRealize//examples//TableAvatars.php';
        require_once '..//classes//CreateRealize//examples//TableRewardsByRaitingsQuality.php';
        require_once '..//classes//CreateRealize//examples//TableTypesElementaryExamples.php';
        require_once '..//classes//CreateRealize//examples//TableUsers.php';

        require_once '..//classes//CreateRealize//examples//TableTypesExamples.php';
        require_once '..//classes//CreateRealize//examples//TableElementaryExamples.php';
        require_once '..//classes//CreateRealize//examples//TableExamples.php';
        require_once '..//classes//CreateRealize//examples//TableGroupsRolesUsers.php';
        require_once '..//classes//CreateRealize//examples//TableRefElemExaWithExamples.php';
        require_once '..//classes//CreateRealize//examples//TableStructuresLessons.php';
        */
    ...
    function InitTablesExamples($db){
        require_once '..//classes//CreateRealize//examples//TableElemExaByTypesId.php';
