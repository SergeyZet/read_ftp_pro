...
<header class="test-header clearfix">
    <div class="layout-position">
        ...
        <div class="test-header-wraper">
            <div class="logo">
                <a href="index.php" class="logo-link"><img src="img/img_landing/Logo-White.png" width="300" height="59" alt="Readium"></a>
            </div>
            <div class="subscription">
                <a class="subscription__link btn" href="#">Оформить подписку</a>
                <div class="reward hidden">
                    <ul>
                        <li class="reward-item reward-item__star reward-item__star--midd">100</li>
            ...
            <div class="user-block">
                ...
                <div class="user-block__avatar">
                    <img src="img/img_landing/avatar1.jpg" alt="ваш аватар">
                </div>
